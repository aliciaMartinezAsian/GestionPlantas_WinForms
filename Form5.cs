    ...
    public partial class Form5 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                PlantaInterior plantaModificada = new PlantaInterior(nombreCientifico, nombreComun, altura, hojas, flor, fruto, num, luz, humedad, toxicidad);
                ...
                for (int i = 0; i < plantas.Count; i++)
                {
                    if (i == indice)
                    {
                        ctr.Modificar(plantas[i], plantaModificada);
                    }
                }
                ...
                MessageBox.Show("Planta modificada con éxito.", "Aviso", MessageBoxButtons.OK, MessageBoxIcon.Information);
